    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class="d-block w-100" src="{{$popup->photo->url}}" alt="" />
...
<div class="section-background--slider">
    <div id="carouselExampleControls" class="carousel slide fix-height" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item {{$i == '1' ? 'active' : '' }} ">
                ...
                $i++;
                @endphp
                <img class="d-block w-100" src="{{$slider->photo->url}}" alt="" />
            </div>
            @endforeach --}}
        </div>
